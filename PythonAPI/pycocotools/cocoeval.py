...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            stats[2] = _summarize(1, iouThr=.60, maxDets=self.params.maxDets[2])
            stats[3] = _summarize(1, iouThr=.75, maxDets=self.params.maxDets[2])
            stats[4] = _summarize(1, iouThr=.80, maxDets=self.params.maxDets[2])
            stats[5] = _summarize(1, iouThr=.90, maxDets=self.params.maxDets[2])
            ...
            stats[10] = _summarize(0)   #MAR
            stats[11] = _summarize(0, iouThr=.50, maxDets=self.params.maxDets[2])
            stats[12] = _summarize(0, iouThr=.60, maxDets=self.params.maxDets[2])
            stats[13] = _summarize(0, iouThr=.75, maxDets=self.params.maxDets[2])
            stats[14] = _summarize(0, iouThr=.80, maxDets=self.params.maxDets[2])
            stats[15] = _summarize(0, iouThr=.90, maxDets=self.params.maxDets[2])
            stats[16] = _summarize(0, iouThr=.95, maxDets=self.params.maxDets[2])
